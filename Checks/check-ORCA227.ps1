...
class ORCA227 : ORCACheck
{
    ...
    ORCA227()
    {
        ...
        $this.Area=Get-LocalizedString -Key "ORCA227_Area"
        $this.Name=Get-LocalizedString -Key "ORCA227_Name"
        $this.PassText=Get-LocalizedString -Key "ORCA227_PassText"
        $this.FailRecommendation=Get-LocalizedString -Key "ORCA227_FailRecommendation"
        $this.Importance=Get-LocalizedString -Key "ORCA227_Importance"
        $this.ExpandResults=$True
        $this.CheckType=[CheckType]::ObjectPropertyValue
        $this.ObjectType=Get-LocalizedString -Key "ORCA227_ObjectType"
        $this.ItemName=Get-LocalizedString -Key "ORCA227_ItemName"
        $this.DataType=Get-LocalizedString -Key "ORCA227_DataType"
        $this.ChiValue=[ORCACHI]::High
        $this.Links= @{
            (Get-LocalizedString -Key "ORCA227_Link_DefenderPortal")="https://security.microsoft.com/safeattachmentv2"
            (Get-LocalizedString -Key "ORCA227_Link_Order")="https://aka.ms/orca-atpp-docs-4"
            (Get-LocalizedString -Key "ORCA227_Link_Settings")="https://aka.ms/orca-atpp-docs-7"
        }
    }
